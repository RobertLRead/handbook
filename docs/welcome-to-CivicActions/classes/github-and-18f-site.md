...
[Outreach](/outreach) is responsible for maintaining the 18F website. [Greg Boone](https://civicactions.slack.com/messages/@gregboone) and [Elaine Kamlley](https://civicactions.slack.com/messages/@elainekamlley) are the product leads.

### Communication

Find us in Slack:

- Use [#18f-site](https://civicactions.slack.com/messages/18f-site) to report issues.
...
The site team works in [#beta-18f-site](https://civicactions.slack.com/messages/beta-18f-site/).
