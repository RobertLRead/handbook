...
* [#press](https://civicactions.slack.com/archives/press) is for collecting press mentions of 18F (non tweets).
* [#18f-site](https://civicactions.slack.com/archives/18f-site) is for managing issues and updates to the current 18f.gsa.gov.
* [#beta-18f-site](https://civicactions.slack.com/archives/beta-18f-site) is for coordinating work on the new redesign of 18f.gsa.gov. 
* [#inbox](https://civicactions.slack.com/archives/inbox) is for coordinating responses to emails that come into 18f@gsa.gov. 
...
- 18F press mentions are collected in [#press](https://civicactions.slack.com/archives/press).
...
Ask in Slack: [#outreach](https://civicactions.slack.com/messages/outreach), [#blog](https://civicactions.slack.com/messages/blog), [#newsletter](https://18f.slack.com/messages/newsletter), [#tweet-this](https://18f.slack.com/messages/tweet-this), or [#press](https://18f.slack.com/messages/press).
