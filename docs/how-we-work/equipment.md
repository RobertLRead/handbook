...
Although some of our employees are based out of a specific office, your badge can be permissioned for multiple GSA buildings. [Kathryn Connolly](https://civicactions.slack.com/messages/@kathryn/) can submit paperwork to start this process, which usually takes a few days. After you receive an email confirmation, you'll need to visit the security office in each new building to activate your card.
...
If you're requesting software that no one else at 18F uses yet, be sure you have written approval from [#infrastructure](https://civicactions.slack.com/messages/infrastructure) first. If it's software that runs directly on your laptop, speak with [Kimber Dowsett](https://civicactions.slack.com/messages/@kimber). Ops will not approve software without Infrastructure clearance.
...
To purchase this type of equipment, go to <https://cap.18f.gov/> and attach a doctor's note. If you have questions, ask in [#equipment](https://civicactions.slack.com/messages/equipment).
...
- Employees are responsible for informing Team Ops in [#equipment](https://civicactions.slack.com/messages/equipment) of the damage or need for repair by the close of business one business day following the damage.
- If either your laptop or your phone is in need of repair, please go to [#teamops](https://civicactions.slack.com/messages/teamops/) for advice. They will likely either ask you to take it to an Apple Store (18F will pay for the repairs), or ship it back to 18F (we'll ship you a new laptop).

## <a id="stolen-or-lost">Lost or stolen equipment</a>

If 18F issued equipment is lost or stolen, follow these mandatory steps.  Employees must follow the GSA procedures for lost or stolen equipment or missing PIV cards, and alert 18F in [#equipment](https://civicactions.slack.com/messages/equipment):

1. Inform [#equipment](https://civicactions.slack.com/messages/equipment) within one business day of learning the equipment is stolen or lost.
...
Ask in Slack: [#equipment](https://civicactions.slack.com/messages/equipment) or [#teamops](https://civicactions.slack.com/messages/teamops)
